...
public class BarChart extends BarLineChartBase<BarData> implements BarDataProvider {
    ...
    public BarChart(Context context, AttributeSet attrs, int defStyle) {
        ...
        setDrawRoundRectF(true);
    }

    @Override
    protected void init() {
        super.init();
        mRenderer = new BarChartRenderer(this, mAnimator, mViewPortHandler,isDrawRoundRect);
    ...
    public void setDrawRoundRectF(boolean isDrawRoundRect) {

 ...
 * @author michal.xu
 */
public class MyBarChart extends BarLineChartBase<BarData> implements BarDataProvider {
    /**
    ...
    protected void init() {
        ...
        startColor = getResources().getColor(R.color.bar_chart_bar_color_blue);
        endColor = getResources().getColor(R.color.bar_chart_bar_color_blue_end);
        this.mRenderer = new MyBarChartRenderer(this, this.mAnimator, this.mViewPortHandler,
                startColor,endColor,isDrawRoundBar, isDrawHalfRoundBar, isDrawGrident);
        }

    public boolean getIsDrawGrident() {
        return isDrawGrident;
    }

    public void setIsDrawGrident(boolean isDrawGrident) {
    ...
    public boolean getIsDrawRoundBar() {
        return isDrawRoundBar;

    }

    public void setIsDrawRoundBar(boolean isDrawRoundBar) {
        this.isDrawRoundBar = isDrawRoundBar;
        this.mRenderer = new MyBarChartRenderer(this, this.mAnimator, this.mViewPortHandler,
                startColor,endColor,isDrawRoundBar, isDrawHalfRoundBar, isDrawGrident);
    }

    public boolean getIsDrawHalfRoundBar() {
        return isDrawHalfRoundBar;
    }

    public void setIsDrawHalfRoundBar(boolean isDrawHalfRoundBar) {

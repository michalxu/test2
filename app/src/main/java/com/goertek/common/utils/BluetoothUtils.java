        ...
        if (bondCallback != null) {
            switch (device.getBondState()) {
                case BluetoothDevice.BOND_NONE:
                    bondCallbackMap.remove(device);
                    LogUtils_goertek.i("[" + device.getName() + "] mac: " + device.getAddress() + " BOND_NONE");
                    break;
                case BluetoothDevice.BOND_BONDING:
                    LogUtils_goertek.i("[" + device.getName() + "] mac: " + device.getAddress() + " BOND_BONDING");
                    break;
                case BluetoothDevice.BOND_BONDED:
                    bondCallbackMap.remove(device);
                    LogUtils_goertek.i("[" + device.getName() + "] mac: " + device.getAddress() + " BOND_BONDED");
                    break;
                default:
                    break;
            }

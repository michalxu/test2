...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    public static int  isDrawDashLine = -1;
    /**
...
//            return;
        if (isDrawDashLine == 0){
            drawPartDashLine(canvas,290,560,44);
            drawPartDashLine(canvas,500,560,44);
            drawPartDashLine(canvas,708,560,44);
        }else if (isDrawDashLine == 1){
            drawPartDashLine(canvas,200,560,44);
            drawPartDashLine(canvas,325,560,44);
            drawPartDashLine(canvas,440,560,44);
            drawPartDashLine(canvas,565,560,44);
            drawPartDashLine(canvas,680,560,44);
            drawPartDashLine(canvas,798,560,44);
        }
